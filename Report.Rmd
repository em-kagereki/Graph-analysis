...
ggplot(all2, aes(x=Degree, color=Aspect)) +
  ...
  theme_classic()+
  labs(
    title = "<b style = 'color:#1381B0;  font-size:32px';> Density plot of degree centrality</b><br>
...
```{r, centrality, fig.asp = 0.6, fig.align = 'center', echo = FALSE, out.width = "100%"}
...
ggplot(betweenAndcentrality, aes(x=betweenness, y=centrality, shape=Category, color=Category)) +
  ...
  labs(x = NULL)+
  labs(
    title = "<b style = 'color:#1381B0;  font-size:32px';>Influential connectors</b><br>
...
ggplot(betweenAndclose, aes(x=betweenness, y=closeness, shape=Category, color=Category)) +
  ...
  theme_classic()+
  labs(
    title = "<b style = 'color:#1381B0;  font-size:32px';> Information flow influencers</b><br>
...
ggraph(subgraph, layout = 'kk') + 
  ...
  theme_classic()+
   labs(
    title = "<b style = 'color:#1381B0;  font-size:32px';>Subset of the network of the top influential genes</b><br>
...
ggplot(siteDrugRank, aes(x = Site, y = Compound, group = Compound)) +
  ...
  geom_line(aes(color = rank), size = 2)+
   labs(
    title = "<b style = 'color:#1381B0;  font-size:32px';>Link prediction (Compound and BTC) based on shared genes</b><br>
...
ggplot(presentLinks, aes(x = siteDrugLink, y = diseaseDrugLink)) +
 ...
 theme_bw(base_size = 15) + theme(legend.position = "bottom") +
  geom_text_repel(
   ...
   labs(
    title = "<b style = 'color:#1381B0;  font-size:32px';>Predicting site specific compounds.</b><br>
    <span style = 'font-size:10pt'> </span>",
